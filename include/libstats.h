...
typedef uint64_t (*uint64_stat)(uint64_t *values, int size);
...
double uint64_stderr(uint64_t *values, int size);
...
void regression(double *x, double *y, double *sig, int n, double *a, double *b, double *sig_a, double *sig_b,
                double *chi2);
